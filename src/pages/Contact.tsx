...
import { Mail, Phone, MapPin, Clock, Send, User, Loader2 } from 'lucide-react';
      ...
      <main className="pt-20">
        ...
        <div className="bg-real-600 text-white py-16">
          <div className="container-custom mx-auto">
            ...
            <p className="text-blue-100 mb-8 max-w-2xl">
              Have questions about a property or need assistance with your search? Our team is here to help.
            </p>
          </div>
        </div>
        ...
        <section className="py-16 bg-gray-50 dark:bg-gray-900">
          <div className="container-custom mx-auto">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                      <div className="flex-shrink-0 mt-1">
                        <MapPin className="h-6 w-6 text-real-600" />
                      </div>
                      <div className="ml-4">
                    ...
                    <div className="flex items-start">
                      <div className="flex-shrink-0 mt-1">
                        <Phone className="h-6 w-6 text-real-600" />
                      </div>
                      <div className="ml-4">
                    ...
                    <div className="flex items-start">
                      <div className="flex-shrink-0 mt-1">
                        <Clock className="h-6 w-6 text-real-600" />
                      </div>
                      <div className="ml-4">
              ...
              <div className="lg:col-span-2">
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-8">
                  ...
                  <form onSubmit={handleSubmit}>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                      <div>
                        ...
                        <div className="relative">
                          ...
                          <input
                            ...
                            required
                            className="pl-10 w-full border border-gray-300 dark:border-gray-700 rounded-lg py-3 px-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-real-400 focus:border-transparent"
                      ...
                      <div>
                        ...
                        <select
                          ...
                          onChange={handleChange}
                          required
                          className="w-full border border-gray-300 dark:border-gray-700 rounded-lg py-3 px-4 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-real-400 focus:border-transparent"
                        >
                    ...
                    <Button 
                      type="submit"
                      className="bg-real-600 hover:bg-real-700 w-full md:w-auto px-8"
                      disabled={loading}
                    >
                      {loading ? (
                        <>
            ...
            {/* Map Section */}
            <div className="mt-16">
              <div className="bg-gray-200 dark:bg-gray-700 rounded-lg overflow-hidden h-[400px]">
                ...
                <div className="w-full h-full flex items-center justify-center text-gray-600 dark:text-gray-400">
                  <div className="text-center">
                    ...
                    <p>123 Real Estate St, New York, NY 10001</p>
                  </div>
                </div>
              </div>
            </div>
